...
import com.student.restaurantfindingapp.Owner.Activity.OwnerReview;
...
public class ReviewAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_review_admin);
    ...
    private void getDetails(){
        ...
        adapter = new ReviewAdapter(getApplicationContext(), reviewClasses, ReviewAdmin.this);
