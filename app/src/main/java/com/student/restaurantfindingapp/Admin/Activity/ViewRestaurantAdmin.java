...
import com.student.restaurantfindingapp.Owner.Activity.OwnerViewRestaurant;
...
public class ViewRestaurantAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_restaurant_admin);
    ...
    private void getDetails(){
        ...
        adapter = new RestaurantListAdapterOwner(getApplicationContext(), restaurantClasses, ViewRestaurantAdmin.this);
